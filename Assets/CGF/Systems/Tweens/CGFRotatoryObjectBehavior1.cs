...
namespace Assets.CGF.Systems.Transform   {
    ...
    /// </summary>
    public class CGFRotatoryObjectBehavior1 : MonoBehaviour {
        ...
        {             
            if (pingPong)
            {
                if (_comeBack == false)
                {
                    ...
                    transform.position = CGFCustomTween.CustomTweenVector3(_localtime, duration, initialAngle, finalAngle, _curve);
                ...
                {
                    _localtime += Time.deltaTime;
                    transform.position = CGFCustomTween.CustomTweenVector3(_localtime, duration, finalAngle, initialAngle, _curve);
    ...
    {
        if ((_actualposition.x == finalAngle.x) || (_actualposition.y == finalAngle.y) || (_actualposition.z == finalAngle.z))
        {
            transform.position = initialAngle;
        }
    }
    #endregion
